...
class Variable(OptimizationBaseFacade):
    ...
    def docs(self) -> str | None:
        try:
            return self._backend.optimization.variables.docs.get(self.id).description
    ...
    def docs(self, description: str | None) -> None:
        if description is None:
            self._backend.optimization.variables.docs.delete(self.id)
        else:
            self._backend.optimization.variables.docs.set(self.id, description)
