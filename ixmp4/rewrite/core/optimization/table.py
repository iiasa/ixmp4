...
class Table(OptimizationBaseFacade):
    ...
    def docs(self) -> str | None:
        try:
            return self._backend.optimization.tables.docs.get(self.id).description
    ...
    def docs(self, description: str | None) -> None:
        if description is None:
            self._backend.optimization.tables.docs.delete(self.id)
        else:
            self._backend.optimization.tables.docs.set(self.id, description)
