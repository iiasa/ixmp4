...
class OptimizationData:
    ...
    def collect_indexsets_to_check(
        columns: list[abstract.optimization.Column],
    ) -> dict[str, Any]:
    ...
    @classmethod
    def validate_data(
        cls, key, data: dict[str, Any], columns: list[abstract.optimization.Column]
    ):
        ...
        limited_to_indexsets = cls.collect_indexsets_to_check(columns=columns)
