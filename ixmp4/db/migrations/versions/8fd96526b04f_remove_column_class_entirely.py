...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f(
                "fk_optimization_equationindexsetassociation_equation_id_optimization_equation"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["indexset_id"],
            ...
            name=op.f(
                "fk_optimization_equationindexsetassociation_indexset_id_optimization_indexset"
            ),
        ),
    ...
    with op.batch_alter_table(
        ...
        batch_op.create_index(
            batch_op.f("ix_optimization_equationindexsetassociation_equation_id"),
            ["equation_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_optimization_equationindexsetassociation_indexset_id"),
            ["indexset_id"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["optimization_indexset.id"],
            name=op.f(
                "fk_optimization_variableindexsetassociation_indexset_id_optimization_indexset"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["variable_id"],
            ...
            name=op.f(
                "fk_optimization_variableindexsetassociation_variable_id_optimization_optimizationvariable"
            ),
        ),
        sa.PrimaryKeyConstraint(
    ...
    with op.batch_alter_table(
        ...
        batch_op.create_index(
            batch_op.f("ix_optimization_variableindexsetassociation_indexset_id"),
            ["indexset_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_optimization_variableindexsetassociation_variable_id"),
            ["variable_id"],
            unique=False,
        )
