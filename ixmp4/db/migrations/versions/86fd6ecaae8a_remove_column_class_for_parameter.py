...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f(
                "fk_optimization_parameterindexsetassociation_indexset_id_optimization_indexset"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["parameter_id"],
            ...
            name=op.f(
                "fk_optimization_parameterindexsetassociation_parameter_id_optimization_parameter"
            ),
        ),
    ...
    with op.batch_alter_table(
        ...
        batch_op.create_index(
            batch_op.f("ix_optimization_parameterindexsetassociation_indexset_id"),
            ["indexset_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_optimization_parameterindexsetassociation_parameter_id"),
            ["parameter_id"],
            unique=False,
        )
