...
def generate_initial_version_data(
    data_table_name: str, version_table: sa.Table, transaction_id: int
):
...
def upgrade():
    ...
    # Add a single transaction initially
    op.bulk_insert(
        transcation,
        [
            {
    ...
    iamc_datapoint_universal_version = op.create_table(
    ...
    generate_initial_version_data(
        "iamc_datapoint_universal", iamc_datapoint_universal_version, 1
    )

    iamc_measurand_version = op.create_table(
    ...
    generate_initial_version_data("iamc_measurand", iamc_measurand_version, 1)

    iamc_timeseries_version = op.create_table(
    ...
    generate_initial_version_data("iamc_timeseries", iamc_timeseries_version, 1)

    iamc_variable_version = op.create_table(
    ...
    generate_initial_version_data("iamc_variable", iamc_variable_version, 1)

    model_version = op.create_table(
        "model_version",
        sa.Column("name", sa.String(length=255), autoincrement=False, nullable=True),
        sa.Column("id", sa.Integer(), autoincrement=False, nullable=False),
        sa.Column("created_at", sa.DateTime(), autoincrement=False, nullable=True),
    ...
    generate_initial_version_data("model", model_version, 1)

    region_version = op.create_table(
        "region_version",
        sa.Column("name", sa.String(length=255), autoincrement=False, nullable=True),
        sa.Column(
    ...
    generate_initial_version_data("region", region_version, 1)

    run_version = op.create_table(
        "run_version",
    ...
    generate_initial_version_data("run", run_version, 1)

    runmetaentry_version = op.create_table(
    ...
    generate_initial_version_data("runmetaentry", runmetaentry_version, 1)

    scenario_version = op.create_table(
        "scenario_version",
        sa.Column("name", sa.String(length=255), autoincrement=False, nullable=True),
        sa.Column("id", sa.Integer(), autoincrement=False, nullable=False),
        sa.Column("created_at", sa.DateTime(), autoincrement=False, nullable=True),
    ...
    generate_initial_version_data("scenario", scenario_version, 1)

    unit_version = op.create_table(
        "unit_version",
        sa.Column("name", sa.String(length=255), autoincrement=False, nullable=True),
        sa.Column("id", sa.Integer(), autoincrement=False, nullable=False),
        sa.Column("created_at", sa.DateTime(), autoincrement=False, nullable=True),
    ...
    generate_initial_version_data("unit", unit_version, 1)
