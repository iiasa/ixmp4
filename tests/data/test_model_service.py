...
class TestModelTabulateVersions(ModelServiceTest):
    def test_model_tabulate_versions(self, versioning_service: ModelService) -> None:
        versioning_service.create("VersionedModel")
        tx_after_insert = int(
        ...
        assert vdf.iloc[0]["name"] == "VersionedModel"
