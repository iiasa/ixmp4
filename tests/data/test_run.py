...
@all_platforms
def test_create_run_increment_version(test_mp):
...
@all_platforms
def test_get_run_versions(test_mp):
...
def test_tabulate_run(test_mp):
    ...
    true_runs = pd.DataFrame(
        ...
        columns=["id", "is_default", "model__id", "scenario__id", "version"],
    )
