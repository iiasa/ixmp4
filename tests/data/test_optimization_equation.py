...
class TestDataOptimizationEquation:
    def test_create_equation(self, platform: ixmp4.Platform) -> None:
        ...
        assert equation_1.indexsets is None
        ...
        assert equation_2.indexsets == [indexset_1.name]
        ...
        assert equation_4.indexsets == [indexset_1.name, indexset_1.name]
    ...
    def test_equation_add_data(self, platform: ixmp4.Platform) -> None:
        ...
        with pytest.raises(
            ...
            platform.backend.optimization.equations.add_data(
                equation_id=equation_5.id,
                data={"foo": ["bar"], "levels": [1], "marginals": [0]},
            )
        ...
        platform.backend.optimization.equations.add_data(
            equation_id=equation_6.id, data=test_data_8
        )
